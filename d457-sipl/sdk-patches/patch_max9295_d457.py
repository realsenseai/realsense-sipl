...
WHAT THIS DOES (idempotent)
  1. MAX9295Hsl.py: adds HSL sequence `set_ser_video_phy_clock_max9295a` — the single-link
     ...
     d4xx serializer init (realsense-holoscan/unused/d457/d457_registers.py, MAX9295A writes).
...
USAGE
  ...
  SIPL_ROOT defaults to /home/mic-742/sipl_full/usr/src/jetson_sipl_api/sipl
"""
import io, os, sys
