...
`d4xx` camera + a reboot, on a remote rig with the DS5 I2C-wedge risk and slow
...
```bash
# CAM_VDD_EN via sysfs LED (per the DS5 firmware notes — confirm the led name on this rig)
