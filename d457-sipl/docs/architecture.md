...
This is the *map*. For the "why" behind any hard-won value, see `.triage/FINDINGS.md`; for current
status and what's left, see `.triage/HANDOVER-d457-sipl-3.md`.
...
`.triage/HANDOVER-d457-sipl-3.md` §4 for the live punch list.
