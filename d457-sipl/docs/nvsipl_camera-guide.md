...
> carved into this repo (`sipl/samples/coe_camera/`) is the **Camera-over-Ethernet** variant and
...
`tools/d457_live.sh` (deployed to `/home/mic-742/d457_live.sh`) does all of the above — tmpfs mount,
power-cycle, capture, and an MJPEG server with an FPS/resolution overlay:
```bash
sudo sh /home/mic-742/d457_live.sh rgb 8080      # stream = rgb|ir|depth, port = 8080
# from your PC:
