...
#   RIG_SUDO_PW=mic-742 ./build_deploy.sh   # authenticate sudo non-interactively (else sudo cached)
#
# ENV OVERRIDES: SIPL, NVSIPL_DRV, QUERY_SRC, JOBS (see defaults below).
set -euo pipefail

SIPL=${SIPL:-/home/mic-742/sipl_full/usr/src/jetson_sipl_api/sipl}
NVSIPL_DRV=${NVSIPL_DRV:-/usr/lib/nvsipl_drv}
QUERY_SRC=${QUERY_SRC:-/home/mic-742/d457_query.cpp}
JOBS=${JOBS:-4}
...
if has query; then
    ...
    QRY_BUILT=/tmp/libnvsipl_qry_d457.so
