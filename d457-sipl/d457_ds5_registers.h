 ...
 *
 * Ported from the known-good Hololink path (realsense-holoscan/unused/d457/d457_registers.py)
 * and reconciled register-for-register against the two ground-truth sources:
 *   - d4xx V4L2 GMSL driver:  C:\work\realsense_mipi_platform_driver\kernel\realsense\d4xx.c
 *   - DS5 B0 firmware:        C:\work\rs-fw-ds5\DS5_B0_DEV\AppServicesLib\{I2cSlaveHostIf,FlowDepth,FlowRgb}.c
 *
 ...
 * DS5-side link; the SoC CSI lane count / D-PHY rate (594000) lives in the SIPL query + the
 * libnvsipl lanes=2 binary patch (see ../.triage/FINDINGS.md). */
