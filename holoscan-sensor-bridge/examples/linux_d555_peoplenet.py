...
class HoloscanApplication(holoscan.core.Application):
    ...
    def compose(self):
        ...
        self.add_flow(image_decoder, image_shift, {("output", "input")})
...
def main():
    ...
    modes = hololink_module.sensors.d555.d555_mode.RealSense_RGB_Mode
    ...
    camera = hololink_module.sensors.d555.d555.RealsenseCamD555(
        hololink_channel, hololink_module.sensors.d555.d555_mode.RealSense_StreamId.RGB
    )
    logging.info("camera mode: %s", args.camera_mode)
    camera_mode = hololink_module.sensors.d555.d555_mode.RealSense_RGB_Mode(
        args.camera_mode
    )
