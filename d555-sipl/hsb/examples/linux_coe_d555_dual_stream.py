...
class HoloscanApplication(holoscan.core.Application):
    ...
    def compose(self):
        ...
        receiver_operator_stream1 = hololink_module.operators.LinuxCoeReceiverOp(
            ...
            pixel_width=self._camera_stream_depth._width,
            coe_channel=hololink_module.sensors.d555.d555_mode.RealSense_StreamId.DEPTH.value
        )

        receiver_operator_stream2 = hololink_module.operators.LinuxCoeReceiverOp(
            self,
            condition_stream2,
            ...
            coe_interface=self._coe_interface,
            pixel_width=self._camera_stream_rgb._width,
            coe_channel=hololink_module.sensors.d555.d555_mode.RealSense_StreamId.RGB.value
        )
