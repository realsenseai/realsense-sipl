...
class HoloscanApplication(holoscan.core.Application):
    ...
    def compose(self):
        ...
        metadata = self._hololink_channel_stream_depth.enumeration_metadata()
        ...
        receiver_operator_stream_depth = hololink_module.operators.FusaCoeCaptureOp(
            self,
            condition_stream1,
            name=f"receiver_operator_stream_depth",
            interface=interface,
        ...
        width = self._camera_stream_depth._width
        height = self._camera_stream_depth._height
        stride = width * 2
        format = hololink_module.sensors.csi.PixelFormat.RAW_12 
        receiver_operator_stream_depth.configure(0, stride, width, height, format, 0)
        
        receiver_operator_stream_rgb = hololink_module.operators.FusaCoeCaptureOp(
            self,
            condition_stream2,
            name=f"receiver_operator_stream_rgb",
            interface=interface,
            mac_addr=hsb_mac_bytes,
        ...
        width = self._camera_stream_rgb._width
        height = self._camera_stream_rgb._height
        stride = width * 2
        format = hololink_module.sensors.csi.PixelFormat.RAW_12 
        receiver_operator_stream_rgb.configure(0, stride, width, height, format, 0)
        ...
        self.add_flow(receiver_operator_stream_depth, image_decoder_stream1, {("output", "input")})
        self.add_flow(receiver_operator_stream_rgb, image_decoder_stream2, {("output", "input")})
...
def main():
    ...
    camera_stream_depth = hololink_module.sensors.d555.d555.RealsenseCamD555(
        hololink_channel_stream_depth, hololink_module.sensors.d555.d555_mode.RealSense_StreamId.DEPTH)
    camera_stream_rgb = hololink_module.sensors.d555.d555.RealsenseCamD555(
        hololink_channel_stream_rgb, hololink_module.sensors.d555.d555_mode.RealSense_StreamId.RGB)
