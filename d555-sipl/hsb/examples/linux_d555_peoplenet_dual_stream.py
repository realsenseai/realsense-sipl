...
class HoloscanApplication(holoscan.core.Application):
    ...
    def compose(self):
        ...
        # Configure depth camera intrinsics/extrinsics for alignment
        depth_intrinsics = self._camera_stream_depth.get_depth_intrinsics()
        rgb_intrinsics = self._camera_stream_depth.get_rgb_intrinsics()
        extrinsics = self._camera_stream_depth.get_extrinsics()

        # Set intrinsics using raw values
        image_decoder_stream1.set_depth_intrinsics(
        ...
        image_decoder_stream1.set_rgb_intrinsics(
        ...
        image_decoder_stream1.set_extrinsics(
        ...
        receiver_operator_stream1 = hololink_module.operators.LinuxReceiverOperator(
            ...
            udp_port=54739
            + hololink_module.sensors.d555.d555_mode.RealSense_StreamId.DEPTH.value,
        ...
        receiver_operator_stream2 = hololink_module.operators.LinuxReceiverOperator(
            ...
            frame_context=frame_context,
            udp_port=54739
            + hololink_module.sensors.d555.d555_mode.RealSense_StreamId.RGB.value,
        ...
        self.add_flow(
            receiver_operator_stream1, image_decoder_stream1, {("output", "input")}
        )
        self.add_flow(
            receiver_operator_stream2, image_decoder_stream2, {("output", "input")}
        )
...
def main():
    ...
    parser.add_argument(
        ...
        default=mode_depth_choices[8],  # 1280x720 30fps depth
        help=mode_help,
    )
    ...
    parser.add_argument(
        ...
        default=mode_rgb_choices[10],  # 1280x720 30fps rgb
        help=mode_help,
    )
    parser.add_argument("--headless", action="store_true", help="Run in headless mode")
    parser.add_argument(
        "--crop", action="store_true", help="crop depth in bounding box", default=True
    )
    parser.add_argument(
    ...
    #
    hololink_channel_stream_depth = hololink_module.DataChannel(
        channel_metadata_stream1
    )
    ...
    camera_stream_rgb = hololink_module.sensors.d555.d555.RealsenseCamD555(
        hololink_channel_stream_rgb,
        hololink_module.sensors.d555.d555_mode.RealSense_StreamId.RGB,
    )
