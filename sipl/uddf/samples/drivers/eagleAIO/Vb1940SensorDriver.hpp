...
#ifndef UDDF_SAMPLES_VB1940SENSORDRIVER_HPP
#define UDDF_SAMPLES_VB1940SENSORDRIVER_HPP
...
/**
 * @brief The declaration of the Vb1940SensorDriver class.
 *
 * This object implements ISensorControl for the VB1940 camera module used in Eagle.
 */
class Vb1940SensorDriver final : public ISensorControl {
public:
    /**
     * @brief Construct a new Vb1940SensorDriver object
     */
    explicit Vb1940SensorDriver();

    /**
     * @brief Destroy the Vb1940SensorDriver object
     */
    ~Vb1940SensorDriver() override;
...
#endif // UDDF_SAMPLES_VB1940SENSORDRIVER_HPP
