...
public:
     ...
     * @retval NVSIPL_STATUS_RESOURCE_ERROR if resource related errors are detected (frame or settings drop).
...
private:
    ...
    /** @brief disable SIPL Control Auto Interface class copy assignment operator */
    ...
    /** @brief disable SIPL Control Auto Interface class move assignment operator */
