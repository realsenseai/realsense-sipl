...
class HoloscanApplication(holoscan.core.Application):
    ...
    def compose(self):
        ...
        receiver_operator_stream1 = hololink_module.operators.LinuxReceiverOperator(
            ...
            udp_port=54739 + d555_registers.RealSense_StreamId.DEPTH.value,
        ...
        receiver_operator_stream2 = hololink_module.operators.LinuxReceiverOperator(
            ...
            frame_size=frame_size,
            frame_context=frame_context,
            udp_port=54739 + d555_registers.RealSense_StreamId.RGB.value,
...
def main():
    ...
    modes_depth = d555_registers.RealSense_Depth_Mode
    ...
    modes_rgb = d555_registers.RealSense_RGB_Mode
    ...
    camera_stream_depth = RealsenseCamD555(hololink_channel_stream_depth, d555_registers.RealSense_StreamId.DEPTH)
    camera_stream_rgb = RealsenseCamD555(hololink_channel_stream_rgb, d555_registers.RealSense_StreamId.RGB)

    logging.info("camera mode stream Depth: %s", args.camera_mode_depth)
    logging.info("camera mode stream RGB: %s", args.camera_mode_rgb)

    camera_mode_depth = d555_registers.RealSense_Depth_Mode(
        args.camera_mode_depth
    )

    camera_mode_rgb = d555_registers.RealSense_RGB_Mode(
