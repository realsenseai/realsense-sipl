...
from d555_registers import RealSense_StreamId, PROFILE_COUNT, RealSense_Mode
...
def main():
    ...
    camera_mode = RealSense_Mode(args.camera_mode % PROFILE_COUNT)
    stream_id = RealSense_StreamId.DEPTH if args.camera_mode < PROFILE_COUNT else RealSense_StreamId.RGB
    camera = RealsenseCamD555(hololink_channel, stream_id)
