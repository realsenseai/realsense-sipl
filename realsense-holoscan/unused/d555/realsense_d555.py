...
from d555_registers import RealSense_StreamCommand, RealSense_StreamId
...
class RealsenseCamD555:
    ...
    def set_mode(self, realsense_mode):
        ...
        if self._stream_id == RealSense_StreamId.DEPTH:
            profiles = d555_registers.depth_stream_profiles
        elif self._stream_id == RealSense_StreamId.RGB:
            profiles = d555_registers.rgb_stream_profiles
        else:
