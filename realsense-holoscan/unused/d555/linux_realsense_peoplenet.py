...
from d555_registers import RealSense_StreamId, RealSense_RGB_Mode
...
def main():
    ...
    camera = RealsenseCamD555(hololink_channel, RealSense_StreamId.RGB)
    logging.info("camera mode: %s", args.camera_mode)
    camera_mode = RealSense_RGB_Mode(
        args.camera_mode
    )
